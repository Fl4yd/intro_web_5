...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"leaflet/leaflet.js":[function(require,module,exports) {
var define;
...
function getMigrationData(_x) {
  return _getMigrationData.apply(this, arguments);
}
function _getMigrationData() {
  _getMigrationData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(url) {
    var Promise;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return fetch(url);
        case 3:
          mapPromise = _context2.sent;
          _context2.next = 6;
          return mapPromise.json();
        case 6:
          data = _context2.sent;
          _context2.next = 9;
...
var getFeature = function getFeature(feature, layer) {
  ...
  var pos = feature.properties.posMigration;
  var neg = feature.properties.negMigration;
  layer.bindPopup("\n  <ul>\n    <li>Name: ".concat(name, "</li>\n    <li>Positive migration: ").concat(pos, "</li>\n    <li>Negative migration: ").concat(neg, "</li>\n  </ul>\n  "));
  layer.bindTooltip(name);
};
var getStyle = function getStyle(feature) {
  var pos = feature.properties.posMigration;
  var neg = feature.properties.negMigration;
  var hue = Math.pow(pos / neg, 3) * 60 < 120 ? Math.pow(pos / neg, 3) * 60 : 120;
  return {
...
drawMap();
},{"./styles.css":"src/styles.css","../leaflet/leaflet":"leaflet/leaflet.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
